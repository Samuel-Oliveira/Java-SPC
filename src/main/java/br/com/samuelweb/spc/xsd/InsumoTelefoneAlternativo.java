 ...
 */
public class InsumoTelefoneAlternativo implements org.apache.axis2.databinding.ADBBean {
        /* This type was generated from the piece of schema that had
           name = Insumo-Telefone-Alternativo
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                        ...
                        namespacePrefix + ":Insumo-Telefone-Alternativo",
                        xmlWriter);
            } else {
                writeAttribute("xsi",
                        "http://www.w3.org/2001/XMLSchema-instance", "type",
                        "Insumo-Telefone-Alternativo", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static InsumoTelefoneAlternativo parse(
                javax.xml.stream.XMLStreamReader reader)
                throws java.lang.Exception {
            InsumoTelefoneAlternativo object = new InsumoTelefoneAlternativo();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"Insumo-Telefone-Alternativo".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                    .getNamespaceURI(nsPrefix);

                            return (InsumoTelefoneAlternativo) ExtensionMapper.getTypeObject(nsUri,
                                    type, reader);
                        }
                    }
                }
