 ...
 */
public class PerfilFinanceiroResultado implements org.apache.axis2.databinding.ADBBean {
        /* This type was generated from the piece of schema that had
           name = perfilFinanceiroResultado
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                        ...
                        namespacePrefix + ":perfilFinanceiroResultado",
                        xmlWriter);
            } else {
                writeAttribute("xsi",
                        "http://www.w3.org/2001/XMLSchema-instance", "type",
                        "perfilFinanceiroResultado", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static PerfilFinanceiroResultado parse(
                javax.xml.stream.XMLStreamReader reader)
                throws java.lang.Exception {
            PerfilFinanceiroResultado object = new PerfilFinanceiroResultado();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"perfilFinanceiroResultado".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                    .getNamespaceURI(nsPrefix);

                            return (PerfilFinanceiroResultado) ExtensionMapper.getTypeObject(nsUri,
                                    type, reader);
                        }
                    }
                }
