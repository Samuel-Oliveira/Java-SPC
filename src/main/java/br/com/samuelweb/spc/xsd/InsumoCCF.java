 ...
 */
public class InsumoCCF implements org.apache.axis2.databinding.ADBBean {
    ...
    public boolean isUltimoChequeSpecified() {
        return localUltimoChequeTracker;
    }
    ...
    /**
     * Auto generated setter method
     * @param param UltimoCheque
     */
    public void setUltimoCheque(Cheque param) {
        localUltimoChequeTracker = param != null;
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                        ...
                        namespacePrefix + ":Insumo-CCF", xmlWriter);
            } else {
                writeAttribute("xsi",
                        "http://www.w3.org/2001/XMLSchema-instance", "type",
                        "Insumo-CCF", xmlWriter);
            }
        }
        ...
        if (localDataUltimoCheque != null) {
            writeAttribute("", "data-ultimo-cheque",
                    org.apache.axis2.databinding.utils.ConverterUtil.convertToString(
                            localDataUltimoCheque), xmlWriter);
        }
    ...
    public static class Factory {
        ...
        public static InsumoCCF parse(
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"Insumo-CCF".equals(type)) {
                            ...
                            return (InsumoCCF) ExtensionMapper.getTypeObject(nsUri,
                                    type, reader);
                        }
                    }
                }
                ...
                java.lang.String tempAttribDataUltimoCheque = reader.getAttributeValue(null,
                        "data-ultimo-cheque");

                if (tempAttribDataUltimoCheque != null) {
                    java.lang.String content = tempAttribDataUltimoCheque;

                    object.setDataUltimoCheque(org.apache.axis2.databinding.utils.ConverterUtil.convertToDateTime(
                            tempAttribDataUltimoCheque));
                } else {
                }
                ...
                java.lang.String tempAttribQuantidade = reader.getAttributeValue(null,
                        "quantidade");

                if (tempAttribQuantidade != null) {
                    java.lang.String content = tempAttribQuantidade;

                    object.setQuantidade(org.apache.axis2.databinding.utils.ConverterUtil.convertToInt(
                            tempAttribQuantidade));
                } else {
                ...
                if ((reader.isStartElement() &&
                        new javax.xml.namespace.QName("", "ultimo-cheque").equals(
                                reader.getName())) ||
                        new javax.xml.namespace.QName("", "ultimo-cheque").equals(
                                reader.getName())) {
