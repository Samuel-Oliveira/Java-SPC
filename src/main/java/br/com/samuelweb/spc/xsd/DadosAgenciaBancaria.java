 ...
 */
public class DadosAgenciaBancaria implements org.apache.axis2.databinding.ADBBean {
        /* This type was generated from the piece of schema that had
           name = Dados-Agencia-Bancaria
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                        ...
                        namespacePrefix + ":Dados-Agencia-Bancaria", xmlWriter);
            } else {
                writeAttribute("xsi",
                        "http://www.w3.org/2001/XMLSchema-instance", "type",
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"Dados-Agencia-Bancaria".equals(type)) {
                            ...
                            return (DadosAgenciaBancaria) ExtensionMapper.getTypeObject(nsUri,
                                    type, reader);
                        }
                    }
                }
