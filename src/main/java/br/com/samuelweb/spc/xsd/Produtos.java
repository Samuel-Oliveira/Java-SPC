 ...
 */
public class Produtos implements org.apache.axis2.databinding.ADBBean {
    ...
    public void serialize(final javax.xml.namespace.QName parentQName,
        ...
        if (localProdutos == null) {
            ...
            writeStartElement(null, namespace, "produtos", xmlWriter);
            ...
            localProdutos.serialize(MY_QNAME, xmlWriter);
        }
    }
                    ...
                    if (reader.isStartElement()) {
                        if ((reader.isStartElement() &&
                                new javax.xml.namespace.QName(
                                        "http://webservice.consulta.spcjava.spcbrasil.org/",
                                        "produtos").equals(reader.getName())) ||
                                new javax.xml.namespace.QName("", "produtos").equals(
                                        reader.getName())) {
                            nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance",
                                    "nil");
                            ...
                            if ("true".equals(nillableValue) ||
                                ...
                                object.setProdutos(ListaProduto.Factory.parse(
                                        reader));
                            }
