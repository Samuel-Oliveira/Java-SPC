 ...
 */
public class TipoAcao implements org.apache.axis2.databinding.ADBBean {
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                        ...
                        namespacePrefix + ":Tipo-Acao", xmlWriter);
            } else {
                writeAttribute("xsi",
                        "http://www.w3.org/2001/XMLSchema-instance", "type",
                        "Tipo-Acao", xmlWriter);
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"Tipo-Acao".equals(type)) {
                            ...
                            return (TipoAcao) ExtensionMapper.getTypeObject(nsUri,
                                    type, reader);
                        }
                    }
                }
