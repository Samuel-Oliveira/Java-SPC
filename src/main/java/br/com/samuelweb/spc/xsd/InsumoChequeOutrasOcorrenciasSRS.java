 ...
 */
public class InsumoChequeOutrasOcorrenciasSRS
        extends InsumoContumaciaSRS implements org.apache.axis2.databinding.ADBBean {
        /* This type was generated from the piece of schema that had
           name = Insumo-Cheque-Outras-Ocorrencias-SRS
    ...
    public void serialize(final javax.xml.namespace.QName parentQName,
        ...
        if ((namespacePrefix != null) &&
            ...
            writeAttribute("xsi",
                    ...
                    namespacePrefix + ":Insumo-Cheque-Outras-Ocorrencias-SRS",
                    xmlWriter);
        } else {
            writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"Insumo-Cheque-Outras-Ocorrencias-SRS".equals(
                                type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                    .getNamespaceURI(nsPrefix);

                            return (InsumoChequeOutrasOcorrenciasSRS) ExtensionMapper.getTypeObject(nsUri,
                                    type, reader);
                        }
                    }
                }
