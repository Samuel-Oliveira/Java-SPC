 ...
 */
public class Cpf implements org.apache.axis2.databinding.ADBBean {
    ...
    public static class Factory {
        ...
        public static Cpf parse(javax.xml.stream.XMLStreamReader reader)
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"Cpf".equals(type)) {
                            ...
                            return (Cpf) ExtensionMapper.getTypeObject(nsUri,
                                    type, reader);
                        }
                    }
                }
                ...
                java.lang.String tempAttribRegiaoOrigem = reader.getAttributeValue(null,
                        "regiao-origem");

                if (tempAttribRegiaoOrigem != null) {
                    java.lang.String content = tempAttribRegiaoOrigem;

                    object.setRegiaoOrigem(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(
                            tempAttribRegiaoOrigem));
                } else {
                }
