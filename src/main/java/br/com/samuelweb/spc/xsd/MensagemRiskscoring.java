 ...
 */
public class MensagemRiskscoring implements org.apache.axis2.databinding.ADBBean {
        /* This type was generated from the piece of schema that had
           name = Mensagem-Riskscoring
           Namespace URI = http://webservice.consulta.spcjava.spcbrasil.org/
           Namespace Prefix = ns1
         */

    /**
     * field for DataMensagemRiskscoring
     * This was an Attribute!
     */
    protected java.util.Calendar localDataMensagemRiskscoring;

    /**
     * field for TextoMensagemRiskscoring
     * This was an Attribute!
     */
     ...
     * @param param DataMensagemRiskscoring
     */
    ...
    /**
     * Auto generated setter method
     * @param param TextoMensagemRiskscoring
     */
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                        ...
                        namespacePrefix + ":Mensagem-Riskscoring", xmlWriter);
            } else {
                writeAttribute("xsi",
                        "http://www.w3.org/2001/XMLSchema-instance", "type",
        ...
        if (localDataMensagemRiskscoring != null) {
            writeAttribute("", "data-mensagem-riskscoring",
                    org.apache.axis2.databinding.utils.ConverterUtil.convertToString(
                            localDataMensagemRiskscoring), xmlWriter);
        }

        if (localTextoMensagemRiskscoring != null) {
            writeAttribute("", "texto-mensagem-riskscoring",
                    org.apache.axis2.databinding.utils.ConverterUtil.convertToString(
                            localTextoMensagemRiskscoring), xmlWriter);
        }
    ...
    public static class Factory {
        ...
        public static MensagemRiskscoring parse(
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"Mensagem-Riskscoring".equals(type)) {
                            ...
                            return (MensagemRiskscoring) ExtensionMapper.getTypeObject(nsUri,
                                    type, reader);
                        }
                    }
                }
                ...
                java.lang.String tempAttribDataMensagemRiskscoring = reader.getAttributeValue(null,
                ...
                if (tempAttribDataMensagemRiskscoring != null) {
                    ...
                    object.setDataMensagemRiskscoring(org.apache.axis2.databinding.utils.ConverterUtil.convertToDateTime(
                            tempAttribDataMensagemRiskscoring));
                } else {
                }
                ...
                java.lang.String tempAttribTextoMensagemRiskscoring = reader.getAttributeValue(null,
                ...
                if (tempAttribTextoMensagemRiskscoring != null) {
                    ...
                    object.setTextoMensagemRiskscoring(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(
                            tempAttribTextoMensagemRiskscoring));
                } else {
                }
