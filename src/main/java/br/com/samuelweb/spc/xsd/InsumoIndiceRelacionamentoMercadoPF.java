 ...
 */
public class InsumoIndiceRelacionamentoMercadoPF implements org.apache.axis2.databinding.ADBBean {
        /* This type was generated from the piece of schema that had
           name = Insumo-Indice-Relacionamento-Mercado-PF
     ...
     * field for Mensagem
     */
    protected MensagemIndiceRelacionamentoMercadoPF localMensagem;
     ...
     * @return MensagemIndiceRelacionamentoMercadoPF
     */
    public MensagemIndiceRelacionamentoMercadoPF getMensagem() {
     ...
     */
    public void setMensagem(MensagemIndiceRelacionamentoMercadoPF param) {
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                        ...
                        namespacePrefix +
                                ":Insumo-Indice-Relacionamento-Mercado-PF", xmlWriter);
            } else {
                writeAttribute("xsi",
                        "http://www.w3.org/2001/XMLSchema-instance", "type",
                        "Insumo-Indice-Relacionamento-Mercado-PF", xmlWriter);
    ...
    public static class Factory {
         ...
         */
        public static InsumoIndiceRelacionamentoMercadoPF parse(
                javax.xml.stream.XMLStreamReader reader)
                throws java.lang.Exception {
            InsumoIndiceRelacionamentoMercadoPF object = new InsumoIndiceRelacionamentoMercadoPF();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"Insumo-Indice-Relacionamento-Mercado-PF".equals(
                                type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                    .getNamespaceURI(nsPrefix);

                            return (InsumoIndiceRelacionamentoMercadoPF) ExtensionMapper.getTypeObject(nsUri,
                                    type, reader);
                        }
                    }
                }
                ...
                if ((reader.isStartElement() &&
                        ...
                        new javax.xml.namespace.QName("", "mensagem").equals(
                                reader.getName())) {
                    object.setMensagem(MensagemIndiceRelacionamentoMercadoPF.Factory.parse(
                            reader));
