 ...
 */
public class ReferenciaComercial implements org.apache.axis2.databinding.ADBBean {
     ...
     * @param param DataConsultaCheque
     */
    ...
    /**
     * Auto generated setter method
     * @param param NomeEmpresaConsultante
     */
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                        ...
                        namespacePrefix + ":Referencia-Comercial", xmlWriter);
            } else {
                writeAttribute("xsi",
                        "http://www.w3.org/2001/XMLSchema-instance", "type",
    ...
    public static class Factory {
        ...
        public static ReferenciaComercial parse(
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"Referencia-Comercial".equals(type)) {
                            ...
                            return (ReferenciaComercial) ExtensionMapper.getTypeObject(nsUri,
                                    type, reader);
                        }
                    }
                }
                ...
                java.lang.String tempAttribDataConsultaCheque = reader.getAttributeValue(null,
                        "data-consulta-cheque");

                if (tempAttribDataConsultaCheque != null) {
                    java.lang.String content = tempAttribDataConsultaCheque;

                    object.setDataConsultaCheque(org.apache.axis2.databinding.utils.ConverterUtil.convertToDateTime(
                            tempAttribDataConsultaCheque));
                } else {
                }
                ...
                java.lang.String tempAttribNomeEmpresaConsultante = reader.getAttributeValue(null,
                ...
                if (tempAttribNomeEmpresaConsultante != null) {
                    ...
                    object.setNomeEmpresaConsultante(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(
                            tempAttribNomeEmpresaConsultante));
                } else {
                }
                ...
                java.lang.String tempAttribOrdemConsulta = reader.getAttributeValue(null,
                        "ordem-consulta");

                if (tempAttribOrdemConsulta != null) {
                    java.lang.String content = tempAttribOrdemConsulta;

                    object.setOrdemConsulta(org.apache.axis2.databinding.utils.ConverterUtil.convertToInt(
                            tempAttribOrdemConsulta));
                } else {
