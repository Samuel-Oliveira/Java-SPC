 ...
 */
public class ResultadoConsumidor implements org.apache.axis2.databinding.ADBBean {
        /* This type was generated from the piece of schema that had
           name = Resultado-Consumidor
    ...
    public boolean isConsumidorPessoaFisicaSpecified() {
        return localConsumidorPessoaFisicaTracker;
    }
     ...
     * @param param ConsumidorPessoaFisica
     */
    public void setConsumidorPessoaFisica(PessoaFisica param) {
        localConsumidorPessoaFisicaTracker = param != null;

        this.localConsumidorPessoaFisica = param;
    }

    public boolean isConsumidorPessoaJuridicaSpecified() {
        return localConsumidorPessoaJuridicaTracker;
    }
    ...
    /**
     * Auto generated setter method
     * @param param ConsumidorPessoaJuridica
     */
    public void setConsumidorPessoaJuridica(PessoaJuridica param) {
        localConsumidorPessoaJuridicaTracker = param != null;
    ...
    public void serialize(final javax.xml.namespace.QName parentQName,
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                        ...
                        namespacePrefix + ":Resultado-Consumidor", xmlWriter);
            } else {
                writeAttribute("xsi",
                        "http://www.w3.org/2001/XMLSchema-instance", "type",
                        "Resultado-Consumidor", xmlWriter);
            }
        }
        ...
        if (localConsumidorPessoaFisicaTracker) {
            ...
            localConsumidorPessoaFisica.serialize(new javax.xml.namespace.QName(
                    "", "consumidor-pessoa-fisica"), xmlWriter);
        }
        ...
        if (localConsumidorPessoaJuridicaTracker) {
            ...
            localConsumidorPessoaJuridica.serialize(new javax.xml.namespace.QName(
                    "", "consumidor-pessoa-juridica"), xmlWriter);
        }
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"Resultado-Consumidor".equals(type)) {
                            ...
                            return (ResultadoConsumidor) ExtensionMapper.getTypeObject(nsUri,
                                    type, reader);
                        }
                    }
                }
                ...
                if ((reader.isStartElement() &&
                        new javax.xml.namespace.QName("",
                                "consumidor-pessoa-fisica").equals(
                                reader.getName())) ||
                        new javax.xml.namespace.QName("",
                                "consumidor-pessoa-fisica").equals(
                                reader.getName())) {
                    object.setConsumidorPessoaFisica(PessoaFisica.Factory.parse(
                            reader));
                ...
                if ((reader.isStartElement() &&
                        new javax.xml.namespace.QName("",
                                "consumidor-pessoa-juridica").equals(
                                reader.getName())) ||
                        new javax.xml.namespace.QName("",
                                "consumidor-pessoa-juridica").equals(
                                reader.getName())) {
                    object.setConsumidorPessoaJuridica(PessoaJuridica.Factory.parse(
                            reader));
