 ...
 */
public class NaturezaAnotacao implements org.apache.axis2.databinding.ADBBean {
        /* This type was generated from the piece of schema that had
           name = Natureza-Anotacao
           Namespace URI = http://webservice.consulta.spcjava.spcbrasil.org/
           Namespace Prefix = ns1
         */

    /**
     * field for DescricaoNaturezaAnotacao
     * This was an Attribute!
     */
    protected java.lang.String localDescricaoNaturezaAnotacao;

    /**
     * field for DescricaoComplementarNaturezaAnotacao
     * This was an Attribute!
     */
     ...
     * @param param DescricaoNaturezaAnotacao
     */
    ...
    /**
     * Auto generated setter method
     * @param param DescricaoComplementarNaturezaAnotacao
     */
    ...
    public void serialize(final javax.xml.namespace.QName parentQName,
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                        ...
                        namespacePrefix + ":Natureza-Anotacao", xmlWriter);
            } else {
                writeAttribute("xsi",
                        "http://www.w3.org/2001/XMLSchema-instance", "type",
        ...
        if (localDescricaoNaturezaAnotacao != null) {
            writeAttribute("", "descricao-natureza-anotacao",
                    org.apache.axis2.databinding.utils.ConverterUtil.convertToString(
                            localDescricaoNaturezaAnotacao), xmlWriter);
        }

        if (localDescricaoComplementarNaturezaAnotacao != null) {
            writeAttribute("", "descricao-complementar-natureza-anotacao",
                    org.apache.axis2.databinding.utils.ConverterUtil.convertToString(
                            localDescricaoComplementarNaturezaAnotacao), xmlWriter);
        }
    ...
    public static class Factory {
        ...
        public static NaturezaAnotacao parse(
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"Natureza-Anotacao".equals(type)) {
                            ...
                            return (NaturezaAnotacao) ExtensionMapper.getTypeObject(nsUri,
                                    type, reader);
                        }
                    }
                }
                ...
                java.lang.String tempAttribDescricaoNaturezaAnotacao = reader.getAttributeValue(null,
                ...
                if (tempAttribDescricaoNaturezaAnotacao != null) {
                    ...
                    object.setDescricaoNaturezaAnotacao(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(
                            tempAttribDescricaoNaturezaAnotacao));
                } else {
                }

                handledAttributes.add("descricao-natureza-anotacao");

                // handle attribute "descricao-complementar-natureza-anotacao"
                ...
                if (tempAttribDescricaoComplementarNaturezaAnotacao != null) {
                    ...
                    object.setDescricaoComplementarNaturezaAnotacao(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(
                            tempAttribDescricaoComplementarNaturezaAnotacao));
                } else {
                }
