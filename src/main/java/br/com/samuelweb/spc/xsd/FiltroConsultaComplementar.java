 ...
 */
public class FiltroConsultaComplementar implements org.apache.axis2.databinding.ADBBean {
        /* This type was generated from the piece of schema that had
           name = Filtro-Consulta-Complementar
    ...
    /**
     * field for NumeroDocumentoSocio
     */
    protected java.lang.String localNumeroDocumentoSocio;

    /*  This tracker boolean wil be used to detect whether the user called the set method
     *   for this attribute. It will be used to determine whether to include this field
     *   in the serialized XML
     */
    protected boolean localNumeroDocumentoSocioTracker = false;
    ...
    public boolean isNumeroDocumentoSocioSpecified() {
        return localNumeroDocumentoSocioTracker;
    }
     ...
     */
    public java.lang.String getNumeroDocumentoSocio() {
        return localNumeroDocumentoSocio;
    }

    /**
     * Auto generated setter method
     * @param param NumeroDocumentoSocio
     */
    public void setNumeroDocumentoSocio(java.lang.String param) {
        localNumeroDocumentoSocioTracker = param != null;

        this.localNumeroDocumentoSocio = param;
    }
    ...
    public void serialize(final javax.xml.namespace.QName parentQName,
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                        ...
                        namespacePrefix + ":Filtro-Consulta-Complementar",
                        xmlWriter);
            } else {
                writeAttribute("xsi",
                        "http://www.w3.org/2001/XMLSchema-instance", "type",
                        "Filtro-Consulta-Complementar", xmlWriter);
            }
        }
        ...
        if (localNumeroDocumentoSocioTracker) {
            namespace = "";
            writeStartElement(null, namespace, "numero-documento-socio",
                    xmlWriter);

            if (localNumeroDocumentoSocio == null) {
                // write the nil attribute
                throw new org.apache.axis2.databinding.ADBException(
                        "numero-documento-socio cannot be null!!");
            } else {
                xmlWriter.writeCharacters(localNumeroDocumentoSocio);
            }
    ...
    public static class Factory {
         ...
         */
        public static FiltroConsultaComplementar parse(
                javax.xml.stream.XMLStreamReader reader)
                throws java.lang.Exception {
            FiltroConsultaComplementar object = new FiltroConsultaComplementar();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"Filtro-Consulta-Complementar".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                    .getNamespaceURI(nsPrefix);

                            return (FiltroConsultaComplementar) ExtensionMapper.getTypeObject(nsUri,
                                    type, reader);
                        }
                    }
                }
                ...
                if ((reader.isStartElement() &&
                    ...
                    if ("true".equals(nillableValue) ||
                            "1".equals(nillableValue)) {
                        throw new org.apache.axis2.databinding.ADBException(
                                "The element: " + "numero-documento-socio" +
                                        "  cannot be null");
                    }

                    java.lang.String content = reader.getElementText();

                    object.setNumeroDocumentoSocio(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(
                            content));
