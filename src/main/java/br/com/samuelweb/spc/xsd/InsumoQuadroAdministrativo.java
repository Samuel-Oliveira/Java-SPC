    ...
    public void serialize(final javax.xml.namespace.QName parentQName,
        ...
        if ((namespacePrefix != null) &&
            ...
            writeAttribute("xsi",
                    ...
                    namespacePrefix + ":Insumo-Quadro-Administrativo", xmlWriter);
        } else {
            writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
        ...
        public static InsumoQuadroAdministrativo parse(
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"Insumo-Quadro-Administrativo".equals(type)) {
                            ...
                            return (InsumoQuadroAdministrativo) ExtensionMapper.getTypeObject(nsUri,
                                    type, reader);
                        }
                    }
                }
                ...
                if (tempAttribEstadoCivil != null) {
                    ...
                    object.setEstadoCivil(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(
                            tempAttribEstadoCivil));
                } else {
                }
