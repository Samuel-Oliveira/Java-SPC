 ...
 */
public class InsumoProduto implements org.apache.axis2.databinding.ADBBean {
    ...
    public void serialize(final javax.xml.namespace.QName parentQName,
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                        ...
                        namespacePrefix + ":Insumo-Produto", xmlWriter);
            } else {
                writeAttribute("xsi",
                        "http://www.w3.org/2001/XMLSchema-instance", "type",
                        "Insumo-Produto", xmlWriter);
            }
        }
        ...
        if (localCodigo != java.lang.Long.MIN_VALUE) {
            writeAttribute("", "codigo",
                    org.apache.axis2.databinding.utils.ConverterUtil.convertToString(
                            localCodigo), xmlWriter);
        }

        if (true) {
            writeAttribute("", "opcional",
                    org.apache.axis2.databinding.utils.ConverterUtil.convertToString(
                            localOpcional), xmlWriter);
        }
        else {
    ...
    public static class Factory {
        ...
        public static InsumoProduto parse(
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"Insumo-Produto".equals(type)) {
                            ...
                            return (InsumoProduto) ExtensionMapper.getTypeObject(nsUri,
                                    type, reader);
                        }
                    }
                }
                ...
                java.lang.String tempAttribCodigo = reader.getAttributeValue(null,
                        "codigo");

                if (tempAttribCodigo != null) {
                    java.lang.String content = tempAttribCodigo;

                    object.setCodigo(org.apache.axis2.databinding.utils.ConverterUtil.convertToLong(
                            tempAttribCodigo));
                } else {
                ...
                java.lang.String tempAttribOpcional = reader.getAttributeValue(null,
                        "opcional");

                if (tempAttribOpcional != null) {
                    java.lang.String content = tempAttribOpcional;

                    object.setOpcional(org.apache.axis2.databinding.utils.ConverterUtil.convertToBoolean(
                            tempAttribOpcional));
                } else {
                    throw new org.apache.axis2.databinding.ADBException(
