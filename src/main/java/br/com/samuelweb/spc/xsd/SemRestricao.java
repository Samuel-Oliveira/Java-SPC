 ...
 */
public class SemRestricao implements org.apache.axis2.databinding.ADBBean {
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                        ...
                        namespacePrefix + ":SemRestricao", xmlWriter);
            } else {
                writeAttribute("xsi",
                        "http://www.w3.org/2001/XMLSchema-instance", "type",
                        "SemRestricao", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static SemRestricao parse(
                javax.xml.stream.XMLStreamReader reader)
                throws java.lang.Exception {
            SemRestricao object = new SemRestricao();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"SemRestricao".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                    .getNamespaceURI(nsPrefix);

                            return (SemRestricao) ExtensionMapper.getTypeObject(nsUri,
                                    type, reader);
                        }
                    }
                }
