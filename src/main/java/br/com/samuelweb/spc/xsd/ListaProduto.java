 ...
 */
public class ListaProduto implements org.apache.axis2.databinding.ADBBean {
    ...
    public boolean isProdutoSpecified() {
        return localProdutoTracker;
    }
    ...
    public void setProduto(Produto[] param) {
        ...
        localProdutoTracker = param != null;
    ...
    public void addProduto(Produto param) {
        ...
        java.util.List list = org.apache.axis2.databinding.utils.ConverterUtil.toList(localProduto);
        list.add(param);
        this.localProduto = (Produto[]) list.toArray(new Produto[list.size()]);
    }
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                        ...
                        namespacePrefix + ":Lista-Produto", xmlWriter);
            } else {
                writeAttribute("xsi",
                        "http://www.w3.org/2001/XMLSchema-instance", "type",
                        "Lista-Produto", xmlWriter);
            }
        }
            ...
            if (localProduto != null) {
                for (int i = 0; i < localProduto.length; i++) {
                    if (localProduto[i] != null) {
                        localProduto[i].serialize(new javax.xml.namespace.QName(
                                "", "produto"), xmlWriter);
                    } else {
        ...
        public static ListaProduto parse(
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"Lista-Produto".equals(type)) {
                            ...
                            return (ListaProduto) ExtensionMapper.getTypeObject(nsUri,
                                    type, reader);
                        }
                    }
                }
                ...
                if ((reader.isStartElement() &&
                        new javax.xml.namespace.QName("", "produto").equals(
                                reader.getName())) ||
                        new javax.xml.namespace.QName("", "produto").equals(
                                reader.getName())) {
                    ...
                    while (!loopDone1) {
                        ...
                        if (reader.isEndElement()) {
                            ...
                            if (new javax.xml.namespace.QName("", "produto").equals(
                                    reader.getName())) {
                                list1.add(Produto.Factory.parse(reader));
                            } else {
                                loopDone1 = true;
                    ...
                    object.setProduto((Produto[]) org.apache.axis2.databinding.utils.ConverterUtil.convertToArray(
                            Produto.class, list1));
