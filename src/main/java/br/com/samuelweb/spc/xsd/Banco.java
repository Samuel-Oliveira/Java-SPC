 ...
 */
public class Banco implements org.apache.axis2.databinding.ADBBean {
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                        ...
                        namespacePrefix + ":Banco", xmlWriter);
            } else {
                writeAttribute("xsi",
                        "http://www.w3.org/2001/XMLSchema-instance", "type",
                        "Banco", xmlWriter);
        ...
        public static Banco parse(javax.xml.stream.XMLStreamReader reader)
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"Banco".equals(type)) {
                            ...
                            return (Banco) ExtensionMapper.getTypeObject(nsUri,
                                    type, reader);
                        }
                    }
                }
                ...
                if (tempAttribCodigo != null) {
                    ...
                    object.setCodigo(org.apache.axis2.databinding.utils.ConverterUtil.convertToInt(
                            tempAttribCodigo));
                } else {
