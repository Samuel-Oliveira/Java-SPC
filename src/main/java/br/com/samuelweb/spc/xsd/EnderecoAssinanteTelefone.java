 ...
 */
public class EnderecoAssinanteTelefone extends Endereco implements org.apache.axis2.databinding.ADBBean {
        /* This type was generated from the piece of schema that had
           name = Endereco-Assinante-Telefone
    ...
    public void serialize(final javax.xml.namespace.QName parentQName,
        ...
        if ((namespacePrefix != null) &&
            ...
            writeAttribute("xsi",
                    ...
                    namespacePrefix + ":Endereco-Assinante-Telefone", xmlWriter);
        } else {
            writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
        ...
        if (localLogradouro != null) {
            writeAttribute("", "logradouro",
                    org.apache.axis2.databinding.utils.ConverterUtil.convertToString(
                            localLogradouro), xmlWriter);
        }

        if (localNumero != null) {
            writeAttribute("", "numero",
                    org.apache.axis2.databinding.utils.ConverterUtil.convertToString(
                            localNumero), xmlWriter);
        }

        if (localComplemento != null) {
            writeAttribute("", "complemento",
                    org.apache.axis2.databinding.utils.ConverterUtil.convertToString(
                            localComplemento), xmlWriter);
        }

        if (localBairro != null) {
            writeAttribute("", "bairro",
                    org.apache.axis2.databinding.utils.ConverterUtil.convertToString(
                            localBairro), xmlWriter);
        }
    ...
    public static class Factory {
        ...
        public static EnderecoAssinanteTelefone parse(
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"Endereco-Assinante-Telefone".equals(type)) {
                            ...
                            return (EnderecoAssinanteTelefone) ExtensionMapper.getTypeObject(nsUri,
                                    type, reader);
                        }
                    }
                }
                ...
                java.lang.String tempAttribLogradouro = reader.getAttributeValue(null,
                        "logradouro");
                ...
                java.lang.String tempAttribNumero = reader.getAttributeValue(null,
                        "numero");
                ...
                java.lang.String tempAttribComplemento = reader.getAttributeValue(null,
                        "complemento");
                ...
                java.lang.String tempAttribBairro = reader.getAttributeValue(null,
                        "bairro");
                ...
                java.lang.String tempAttribTipoLogradouro = reader.getAttributeValue(null,
                        "tipo-logradouro");

                if (tempAttribTipoLogradouro != null) {
                    java.lang.String content = tempAttribTipoLogradouro;

                    object.setTipoLogradouro(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(
                            tempAttribTipoLogradouro));
                } else {
                }
