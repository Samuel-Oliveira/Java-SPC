 ...
 */
public class InsumoDadosTelefoneConsultado implements org.apache.axis2.databinding.ADBBean {
        /* This type was generated from the piece of schema that had
           name = Insumo-Dados-Telefone-Consultado
    ...
    public boolean isAssinanteSpecified() {
        return localAssinanteTracker;
    }
     ...
     * @param param Assinante
     */
    public void setAssinante(AssinanteTelefone param) {
        localAssinanteTracker = param != null;
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                        ...
                        namespacePrefix + ":Insumo-Dados-Telefone-Consultado",
                        xmlWriter);
            } else {
                writeAttribute("xsi",
                        "http://www.w3.org/2001/XMLSchema-instance", "type",
                        "Insumo-Dados-Telefone-Consultado", xmlWriter);
            }
        }
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"Insumo-Dados-Telefone-Consultado".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                    .getNamespaceURI(nsPrefix);

                            return (InsumoDadosTelefoneConsultado) ExtensionMapper.getTypeObject(nsUri,
                                    type, reader);
                        }
                    }
                }
                ...
                if ((reader.isStartElement() &&
                        new javax.xml.namespace.QName("", "assinante").equals(
                                reader.getName())) ||
                        new javax.xml.namespace.QName("", "assinante").equals(
                                reader.getName())) {
                    object.setAssinante(AssinanteTelefone.Factory.parse(
                            reader));
