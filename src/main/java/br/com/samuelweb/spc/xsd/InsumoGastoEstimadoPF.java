 ...
 */
public class InsumoGastoEstimadoPF implements org.apache.axis2.databinding.ADBBean {
        /* This type was generated from the piece of schema that had
           name = Insumo-Gasto-Estimado-PF
     ...
     * field for Mensagem
     */
    protected MensagemGastoEstimadoPF localMensagem;
     ...
     * @return MensagemGastoEstimadoPF
     */
    public MensagemGastoEstimadoPF getMensagem() {
     ...
     */
    public void setMensagem(MensagemGastoEstimadoPF param) {
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                        ...
                        namespacePrefix + ":Insumo-Gasto-Estimado-PF", xmlWriter);
            } else {
                writeAttribute("xsi",
                        "http://www.w3.org/2001/XMLSchema-instance", "type",
                        "Insumo-Gasto-Estimado-PF", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static InsumoGastoEstimadoPF parse(
                javax.xml.stream.XMLStreamReader reader)
                throws java.lang.Exception {
            InsumoGastoEstimadoPF object = new InsumoGastoEstimadoPF();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"Insumo-Gasto-Estimado-PF".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                    .getNamespaceURI(nsPrefix);

                            return (InsumoGastoEstimadoPF) ExtensionMapper.getTypeObject(nsUri,
                                    type, reader);
                        }
                    }
                }
                ...
                if ((reader.isStartElement() &&
                        ...
                        new javax.xml.namespace.QName("", "mensagem").equals(
                                reader.getName())) {
                    object.setMensagem(MensagemGastoEstimadoPF.Factory.parse(
                            reader));
