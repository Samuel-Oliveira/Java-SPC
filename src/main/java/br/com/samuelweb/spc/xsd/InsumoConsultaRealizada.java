 ...
 */
public class InsumoConsultaRealizada implements org.apache.axis2.databinding.ADBBean {
        /* This type was generated from the piece of schema that had
           name = Insumo-Consulta-Realizada
    ...
    /**
     * field for NomeEntidadeOrigem
     * This was an Attribute!
     */
    protected java.lang.String localNomeEntidadeOrigem;

    public boolean isOrigemAssociadoSpecified() {
        return localOrigemAssociadoTracker;
    }
     ...
     * @param param OrigemAssociado
     */
    public void setOrigemAssociado(Cidade param) {
        localOrigemAssociadoTracker = param != null;
    ...
    /**
     * Auto generated setter method
     * @param param NomeEntidadeOrigem
     */
    ...
    public void serialize(final javax.xml.namespace.QName parentQName,
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                        ...
                        namespacePrefix + ":Insumo-Consulta-Realizada",
                        xmlWriter);
            } else {
                writeAttribute("xsi",
                        "http://www.w3.org/2001/XMLSchema-instance", "type",
        ...
        if (localNomeEntidadeOrigem != null) {
            writeAttribute("", "nome-entidade-origem",
                    org.apache.axis2.databinding.utils.ConverterUtil.convertToString(
                            localNomeEntidadeOrigem), xmlWriter);
        }
    ...
    public static class Factory {
        ...
        public static InsumoConsultaRealizada parse(
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"Insumo-Consulta-Realizada".equals(type)) {
                            ...
                            return (InsumoConsultaRealizada) ExtensionMapper.getTypeObject(nsUri,
                                    type, reader);
                        }
                    }
                }
                ...
                java.lang.String tempAttribNomeEntidadeOrigem = reader.getAttributeValue(null,
                        "nome-entidade-origem");

                if (tempAttribNomeEntidadeOrigem != null) {
                    java.lang.String content = tempAttribNomeEntidadeOrigem;

                    object.setNomeEntidadeOrigem(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(
                            tempAttribNomeEntidadeOrigem));
                } else {
                }
                ...
                if ((reader.isStartElement() &&
                        new javax.xml.namespace.QName("", "origem-associado").equals(
                                reader.getName())) ||
                        new javax.xml.namespace.QName("", "origem-associado").equals(
                                reader.getName())) {
