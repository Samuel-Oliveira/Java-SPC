 ...
 */
public class InsumoHistoricoChequeDocumentoDiferente
        extends InsumoHistoricoCheque implements org.apache.axis2.databinding.ADBBean {
        /* This type was generated from the piece of schema that had
           name = Insumo-Historico-Cheque-Documento-Diferente
    ...
    public void serialize(final javax.xml.namespace.QName parentQName,
        ...
        if ((namespacePrefix != null) &&
            ...
            writeAttribute("xsi",
                    ...
                    namespacePrefix +
                            ":Insumo-Historico-Cheque-Documento-Diferente", xmlWriter);
        } else {
            writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "Insumo-Historico-Cheque-Documento-Diferente", xmlWriter);
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"Insumo-Historico-Cheque-Documento-Diferente".equals(
                                type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                    .getNamespaceURI(nsPrefix);

                            return (InsumoHistoricoChequeDocumentoDiferente) ExtensionMapper.getTypeObject(nsUri,
                                    type, reader);
                        }
                    }
                }
