 ...
 */
public class CartorioObito implements org.apache.axis2.databinding.ADBBean {
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                        ...
                        namespacePrefix + ":Cartorio-Obito", xmlWriter);
            } else {
                writeAttribute("xsi",
                        "http://www.w3.org/2001/XMLSchema-instance", "type",
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"Cartorio-Obito".equals(type)) {
                            ...
                            return (CartorioObito) ExtensionMapper.getTypeObject(nsUri,
                                    type, reader);
                        }
                    }
                }
