 ...
 */
public class PerfilFinanceiroFraseConclusao implements org.apache.axis2.databinding.ADBBean {
        /* This type was generated from the piece of schema that had
           name = perfilFinanceiroFraseConclusao
     ...
     */
    protected java.lang.String localFraseConclusao;
     ...
     * @return java.lang.String
     */
    public java.lang.String getFraseConclusao() {
     ...
     */
    public void setFraseConclusao(java.lang.String param) {
    ...
    public void serialize(final javax.xml.namespace.QName parentQName,
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                        ...
                        namespacePrefix + ":perfilFinanceiroFraseConclusao",
                        xmlWriter);
            } else {
                writeAttribute("xsi",
                        "http://www.w3.org/2001/XMLSchema-instance", "type",
                        "perfilFinanceiroFraseConclusao", xmlWriter);
            }
        }
        ...
        if (localFraseConclusaoTracker) {
            namespace = "";
            writeStartElement(null, namespace, "fraseConclusao", xmlWriter);

            if (localFraseConclusao == null) {
                // write the nil attribute
                throw new org.apache.axis2.databinding.ADBException(
                        "fraseConclusao cannot be null!!");
            } else {
                xmlWriter.writeCharacters(localFraseConclusao);
            }
    ...
    public static class Factory {
         ...
         */
        public static PerfilFinanceiroFraseConclusao parse(
                javax.xml.stream.XMLStreamReader reader)
                throws java.lang.Exception {
            PerfilFinanceiroFraseConclusao object = new PerfilFinanceiroFraseConclusao();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"perfilFinanceiroFraseConclusao".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                    .getNamespaceURI(nsPrefix);

                            return (PerfilFinanceiroFraseConclusao) ExtensionMapper.getTypeObject(nsUri,
                                    type, reader);
                        }
                    }
                }
                ...
                if ((reader.isStartElement() &&
                        new javax.xml.namespace.QName("", "fraseConclusao").equals(
                                reader.getName())) ||
                        new javax.xml.namespace.QName("", "fraseConclusao").equals(
                                reader.getName())) {
                    nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance",
                    ...
                    if ("true".equals(nillableValue) ||
                            "1".equals(nillableValue)) {
                        throw new org.apache.axis2.databinding.ADBException(
                                "The element: " + "fraseConclusao" +
                                        "  cannot be null");
                    }

                    java.lang.String content = reader.getElementText();

                    object.setFraseConclusao(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(
                            content));
