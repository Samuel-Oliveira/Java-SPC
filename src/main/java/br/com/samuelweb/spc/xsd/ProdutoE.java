 ...
 */
public class ProdutoE implements org.apache.axis2.databinding.ADBBean {
    ...
    public void serialize(final javax.xml.namespace.QName parentQName,
        ...
        if (localProduto == null) {
            ...
            writeStartElement(null, namespace, "produto", xmlWriter);
            ...
            localProduto.serialize(MY_QNAME, xmlWriter);
        }
    }
                    ...
                    if (reader.isStartElement()) {
                        if ((reader.isStartElement() &&
                            ...
                            if ("true".equals(nillableValue) ||
                                ...
                                object.setProduto(Produto.Factory.parse(
                                        reader));
                            }
