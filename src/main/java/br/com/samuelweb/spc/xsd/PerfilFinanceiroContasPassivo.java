 ...
 */
public class PerfilFinanceiroContasPassivo implements org.apache.axis2.databinding.ADBBean {
        /* This type was generated from the piece of schema that had
           name = perfilFinanceiroContasPassivo
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                        ...
                        namespacePrefix + ":perfilFinanceiroContasPassivo",
                        xmlWriter);
            } else {
                writeAttribute("xsi",
                        "http://www.w3.org/2001/XMLSchema-instance", "type",
                        "perfilFinanceiroContasPassivo", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static PerfilFinanceiroContasPassivo parse(
                javax.xml.stream.XMLStreamReader reader)
                throws java.lang.Exception {
            PerfilFinanceiroContasPassivo object = new PerfilFinanceiroContasPassivo();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"perfilFinanceiroContasPassivo".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                    .getNamespaceURI(nsPrefix);

                            return (PerfilFinanceiroContasPassivo) ExtensionMapper.getTypeObject(nsUri,
                                    type, reader);
                        }
                    }
                }
