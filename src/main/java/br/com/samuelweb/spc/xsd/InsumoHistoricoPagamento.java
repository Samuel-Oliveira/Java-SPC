 ...
 * Data: 01/09/2017 - 10:01
 */
public class InsumoHistoricoPagamento implements org.apache.axis2.databinding.ADBBean {
        /* This type was generated from the piece of schema that had
           name = Insumo-Historico-Pagamento
           Namespace URI = http://webservice.consulta.spcjava.spcbrasil.org/
           Namespace Prefix = ns1
         */

    /**
     * field for DescricaoPeriodo
     * This was an Attribute!
     */
    protected java.lang.String localDescricaoPeriodo;

    /**
     * field for PercentualPeriodo
     * This was an Attribute!
     */
    protected int localPercentualPeriodo;

    /**
     * field for QuantidadeFontes
     * This was an Attribute!
     */
    protected int localQuantidadeFontes;

    /**
     * field for QuantidadePeriodo
     * This was an Attribute!
     */
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                        ...
                        namespacePrefix + ":Insumo-Historico-Pagamento",
                        xmlWriter);
            } else {
                writeAttribute("xsi",
                        "http://www.w3.org/2001/XMLSchema-instance", "type",
    ...
    public static class Factory {
        ...
        public static InsumoHistoricoPagamento parse(
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"Insumo-Historico-Pagamento".equals(type)) {
                            ...
                            return (InsumoHistoricoPagamento) ExtensionMapper.getTypeObject(nsUri,
                                    type, reader);
                        }
                    }
                }
                ...
                java.lang.String tempAttribDescricaoPeriodo = reader.getAttributeValue(null,
                        "descricao-periodo");

                if (tempAttribDescricaoPeriodo != null) {
                    java.lang.String content = tempAttribDescricaoPeriodo;

                    object.setDescricaoPeriodo(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(
                            tempAttribDescricaoPeriodo));
                } else {
                }
                ...
                java.lang.String tempAttribPercentualPeriodo = reader.getAttributeValue(null,
                        "percentual-periodo");

                if (tempAttribPercentualPeriodo != null) {
                    java.lang.String content = tempAttribPercentualPeriodo;

                    object.setPercentualPeriodo(org.apache.axis2.databinding.utils.ConverterUtil.convertToInt(
                            tempAttribPercentualPeriodo));
                } else {
                ...
                java.lang.String tempAttribQuantidadeFontes = reader.getAttributeValue(null,
                        "quantidade-fontes");

                if (tempAttribQuantidadeFontes != null) {
                    java.lang.String content = tempAttribQuantidadeFontes;

                    object.setQuantidadeFontes(org.apache.axis2.databinding.utils.ConverterUtil.convertToInt(
                            tempAttribQuantidadeFontes));
                } else {
                ...
                java.lang.String tempAttribQuantidadePeriodo = reader.getAttributeValue(null,
                        "quantidade-periodo");

                if (tempAttribQuantidadePeriodo != null) {
                    java.lang.String content = tempAttribQuantidadePeriodo;

                    object.setQuantidadePeriodo(org.apache.axis2.databinding.utils.ConverterUtil.convertToInt(
                            tempAttribQuantidadePeriodo));
                } else {
