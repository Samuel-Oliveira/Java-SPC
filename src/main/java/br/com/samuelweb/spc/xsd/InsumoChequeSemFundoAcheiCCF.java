 ...
 */
public class InsumoChequeSemFundoAcheiCCF implements org.apache.axis2.databinding.ADBBean {
        /* This type was generated from the piece of schema that had
           name = Insumo-Cheque-Sem-Fundo-Achei-CCF
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                        ...
                        namespacePrefix + ":Insumo-Cheque-Sem-Fundo-Achei-CCF",
                        xmlWriter);
            } else {
                writeAttribute("xsi",
                        "http://www.w3.org/2001/XMLSchema-instance", "type",
                        "Insumo-Cheque-Sem-Fundo-Achei-CCF", xmlWriter);
            }
        }
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"Insumo-Cheque-Sem-Fundo-Achei-CCF".equals(
                                type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                    .getNamespaceURI(nsPrefix);

                            return (InsumoChequeSemFundoAcheiCCF) ExtensionMapper.getTypeObject(nsUri,
                                    type, reader);
                        }
                    }
                }
                ...
                java.lang.String tempAttribNumeroCheque = reader.getAttributeValue(null,
                        "numero-cheque");

                if (tempAttribNumeroCheque != null) {
                    java.lang.String content = tempAttribNumeroCheque;

                    object.setNumeroCheque(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(
                            tempAttribNumeroCheque));
                } else {
                }
