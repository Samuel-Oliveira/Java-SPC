 ...
 */
public class Vara implements org.apache.axis2.databinding.ADBBean {
    ...
    public boolean isComarcaSpecified() {
        return localComarcaTracker;
    }
    ...
    public void setComarca(Cidade param) {
        localComarcaTracker = param != null;
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                        ...
                        namespacePrefix + ":Vara", xmlWriter);
            } else {
                writeAttribute("xsi",
                        "http://www.w3.org/2001/XMLSchema-instance", "type",
                        "Vara", xmlWriter);
        ...
        public static Vara parse(javax.xml.stream.XMLStreamReader reader)
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"Vara".equals(type)) {
                            ...
                            return (Vara) ExtensionMapper.getTypeObject(nsUri,
                                    type, reader);
                        }
                    }
                }
                ...
                if ((reader.isStartElement() &&
                        new javax.xml.namespace.QName("", "comarca").equals(
                                reader.getName())) ||
                        new javax.xml.namespace.QName("", "comarca").equals(
                                reader.getName())) {
