 ...
 * Data: 01/09/2017 - 09:58
 */
public class InsumoContraOrdemDocumentoDiferente
        extends InsumoContraOrdem implements org.apache.axis2.databinding.ADBBean {
        /* This type was generated from the piece of schema that had
           name = Insumo-Contra-Ordem-Documento-Diferente
    ...
    /**
     * field for CodigoTipoDocumento
     * This was an Attribute!
     */
    protected int localCodigoTipoDocumento;
    ...
    public int getCodigoTipoDocumento() {
        return localCodigoTipoDocumento;
    }

    /**
     * Auto generated setter method
     * @param param CodigoTipoDocumento
     */
    public void setCodigoTipoDocumento(int param) {
        this.localCodigoTipoDocumento = param;
    }
    ...
    public void serialize(final javax.xml.namespace.QName parentQName,
        ...
        if (localCodigoTipoDocumento != java.lang.Integer.MIN_VALUE) {
            writeAttribute("", "codigo-tipo-documento",
                    org.apache.axis2.databinding.utils.ConverterUtil.convertToString(
                            localCodigoTipoDocumento), xmlWriter);
        }
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"Insumo-Contra-Ordem-Documento-Diferente".equals(
                                type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                    .getNamespaceURI(nsPrefix);

                            return (InsumoContraOrdemDocumentoDiferente) ExtensionMapper.getTypeObject(nsUri,
                                    type, reader);
                        }
                    }
                }
                ...
                // handle attribute "codigo-tipo-documento"
                java.lang.String tempAttribCodigoTipoDocumento = reader.getAttributeValue(null,
                        "codigo-tipo-documento");

                if (tempAttribCodigoTipoDocumento != null) {
                    java.lang.String content = tempAttribCodigoTipoDocumento;

                    object.setCodigoTipoDocumento(org.apache.axis2.databinding.utils.ConverterUtil.convertToInt(
                            tempAttribCodigoTipoDocumento));
                } else {
                    object.setCodigoTipoDocumento(java.lang.Integer.MIN_VALUE);
                }

                handledAttributes.add("codigo-tipo-documento");
