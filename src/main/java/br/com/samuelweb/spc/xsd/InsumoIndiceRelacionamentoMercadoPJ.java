 ...
 */
public class InsumoIndiceRelacionamentoMercadoPJ implements org.apache.axis2.databinding.ADBBean {
        /* This type was generated from the piece of schema that had
           name = Insumo-Indice-Relacionamento-Mercado-PJ
     ...
     * field for Mensagem
     */
    protected MensagemIndiceRelacionamentoMercadoPJ localMensagem;
     ...
     * @return MensagemIndiceRelacionamentoMercadoPJ
     */
    public MensagemIndiceRelacionamentoMercadoPJ getMensagem() {
     ...
     */
    public void setMensagem(MensagemIndiceRelacionamentoMercadoPJ param) {
    ...
    public void serialize(final javax.xml.namespace.QName parentQName,
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                        ...
                        namespacePrefix +
                                ":Insumo-Indice-Relacionamento-Mercado-PJ", xmlWriter);
            } else {
                writeAttribute("xsi",
                        "http://www.w3.org/2001/XMLSchema-instance", "type",
                        "Insumo-Indice-Relacionamento-Mercado-PJ", xmlWriter);
        ...
        if (localMensagemTracker) {
            ...
            localMensagem.serialize(new javax.xml.namespace.QName("",
                    "mensagem"), xmlWriter);
        }
    ...
    public static class Factory {
         ...
         */
        public static InsumoIndiceRelacionamentoMercadoPJ parse(
                javax.xml.stream.XMLStreamReader reader)
                throws java.lang.Exception {
            InsumoIndiceRelacionamentoMercadoPJ object = new InsumoIndiceRelacionamentoMercadoPJ();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"Insumo-Indice-Relacionamento-Mercado-PJ".equals(
                                type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                    .getNamespaceURI(nsPrefix);

                            return (InsumoIndiceRelacionamentoMercadoPJ) ExtensionMapper.getTypeObject(nsUri,
                                    type, reader);
                        }
                    }
                }
                ...
                if ((reader.isStartElement() &&
                        ...
                        new javax.xml.namespace.QName("", "mensagem").equals(
                                reader.getName())) {
                    object.setMensagem(MensagemIndiceRelacionamentoMercadoPJ.Factory.parse(
                            reader));
                ...
                if ((reader.isStartElement() &&
                    ...
                    object.setValor(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(
                            content));
