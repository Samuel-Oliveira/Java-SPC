 ...
 */
public class TipoDocumentoAlerta implements org.apache.axis2.databinding.ADBBean {
        /* This type was generated from the piece of schema that had
           name = Tipo-Documento-Alerta
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                        ...
                        namespacePrefix + ":Tipo-Documento-Alerta", xmlWriter);
            } else {
                writeAttribute("xsi",
                        "http://www.w3.org/2001/XMLSchema-instance", "type",
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"Tipo-Documento-Alerta".equals(type)) {
                            ...
                            return (TipoDocumentoAlerta) ExtensionMapper.getTypeObject(nsUri,
                                    type, reader);
                        }
                    }
                }
