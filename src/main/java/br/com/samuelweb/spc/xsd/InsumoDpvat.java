 ...
 */
public class InsumoDpvat extends AbstractInsumoSPCAuto implements org.apache.axis2.databinding.ADBBean {
     ...
     * This was an Attribute!
     */
    protected int localExercicio;

    /**
     * field for DataPagamento
     * This was an Attribute!
     */
    protected java.lang.String localDataPagamento;
    ...
    /**
     * Auto generated setter method
     * @param param Exercicio
     */
    public void setExercicio(int param) {
        this.localExercicio = param;
    }
    ...
    public java.lang.String getDataPagamento() {
        return localDataPagamento;
    }

    /**
     * Auto generated setter method
     * @param param DataPagamento
     */
    public void setDataPagamento(java.lang.String param) {
        this.localDataPagamento = param;
    }
    ...
    public void serialize(final javax.xml.namespace.QName parentQName,
        ...
        if ((namespacePrefix != null) &&
            ...
            writeAttribute("xsi",
                    ...
                    namespacePrefix + ":Insumo-Dpvat", xmlWriter);
        } else {
            writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "Insumo-Dpvat", xmlWriter);
        }
        ...
        if (localExercicio != java.lang.Integer.MIN_VALUE) {
            writeAttribute("", "exercicio",
                    org.apache.axis2.databinding.utils.ConverterUtil.convertToString(
                            localExercicio), xmlWriter);
        }

        if (localDataPagamento != null) {
            writeAttribute("", "data-pagamento",
                    org.apache.axis2.databinding.utils.ConverterUtil.convertToString(
                            localDataPagamento), xmlWriter);
        }
    ...
    public static class Factory {
         ...
         */
        public static InsumoDpvat parse(
                javax.xml.stream.XMLStreamReader reader)
                throws java.lang.Exception {
            InsumoDpvat object = new InsumoDpvat();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"Insumo-Dpvat".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                    .getNamespaceURI(nsPrefix);

                            return (InsumoDpvat) ExtensionMapper.getTypeObject(nsUri,
                                    type, reader);
                        }
                    }
                }
                ...
                // handle attribute "exercicio"
                java.lang.String tempAttribExercicio = reader.getAttributeValue(null,
                        "exercicio");

                if (tempAttribExercicio != null) {
                    java.lang.String content = tempAttribExercicio;

                    object.setExercicio(org.apache.axis2.databinding.utils.ConverterUtil.convertToInt(
                            tempAttribExercicio));
                } else {
                    object.setExercicio(java.lang.Integer.MIN_VALUE);
                }

                handledAttributes.add("exercicio");

                // handle attribute "data-pagamento"
                java.lang.String tempAttribDataPagamento = reader.getAttributeValue(null,
                        "data-pagamento");

                if (tempAttribDataPagamento != null) {
                    java.lang.String content = tempAttribDataPagamento;

                    object.setDataPagamento(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(
                            tempAttribDataPagamento));
                } else {
                }

                handledAttributes.add("data-pagamento");
