 ...
 */
public class SituacaoDocumentoWS implements org.apache.axis2.databinding.ADBBean {
        /* This type was generated from the piece of schema that had
           name = Situacao-Documento-WS
           Namespace URI = http://webservice.consulta.spcjava.spcbrasil.org/
           Namespace Prefix = ns1
         */

    /**
     * field for DescricaoSituacao
     * This was an Attribute!
     */
    protected java.lang.String localDescricaoSituacao;

    /**
     * field for DataSituacao
     * This was an Attribute!
     */
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                        ...
                        namespacePrefix + ":Situacao-Documento-WS", xmlWriter);
            } else {
                writeAttribute("xsi",
                        "http://www.w3.org/2001/XMLSchema-instance", "type",
                        "Situacao-Documento-WS", xmlWriter);
            }
        }
        ...
        if (localDescricaoSituacao != null) {
            writeAttribute("", "descricao-situacao",
                    org.apache.axis2.databinding.utils.ConverterUtil.convertToString(
                            localDescricaoSituacao), xmlWriter);
        }

        if (localDataSituacao != null) {
            writeAttribute("", "data-situacao",
                    org.apache.axis2.databinding.utils.ConverterUtil.convertToString(
                            localDataSituacao), xmlWriter);
        }
    ...
    public static class Factory {
        ...
        public static SituacaoDocumentoWS parse(
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"Situacao-Documento-WS".equals(type)) {
                            ...
                            return (SituacaoDocumentoWS) ExtensionMapper.getTypeObject(nsUri,
                                    type, reader);
                        }
                    }
                }
                ...
                java.lang.String tempAttribDescricaoSituacao = reader.getAttributeValue(null,
                        "descricao-situacao");

                if (tempAttribDescricaoSituacao != null) {
                    java.lang.String content = tempAttribDescricaoSituacao;

                    object.setDescricaoSituacao(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(
                            tempAttribDescricaoSituacao));
                } else {
                }
                ...
                java.lang.String tempAttribDataSituacao = reader.getAttributeValue(null,
                        "data-situacao");

                if (tempAttribDataSituacao != null) {
                    java.lang.String content = tempAttribDataSituacao;

                    object.setDataSituacao(org.apache.axis2.databinding.utils.ConverterUtil.convertToDateTime(
                            tempAttribDataSituacao));
                } else {
                }
