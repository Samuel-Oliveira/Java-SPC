 ...
 */
public class InsumoGastoEstimadoPJ implements org.apache.axis2.databinding.ADBBean {
        /* This type was generated from the piece of schema that had
           name = Insumo-Gasto-Estimado-PJ
     ...
     * field for Mensagem
     */
    protected MensagemGastoEstimadoPJ localMensagem;
     ...
     * @return MensagemGastoEstimadoPJ
     */
    public MensagemGastoEstimadoPJ getMensagem() {
     ...
     */
    public void setMensagem(MensagemGastoEstimadoPJ param) {
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                        ...
                        namespacePrefix + ":Insumo-Gasto-Estimado-PJ", xmlWriter);
            } else {
                writeAttribute("xsi",
                        "http://www.w3.org/2001/XMLSchema-instance", "type",
                        "Insumo-Gasto-Estimado-PJ", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static InsumoGastoEstimadoPJ parse(
                javax.xml.stream.XMLStreamReader reader)
                throws java.lang.Exception {
            InsumoGastoEstimadoPJ object = new InsumoGastoEstimadoPJ();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"Insumo-Gasto-Estimado-PJ".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                    .getNamespaceURI(nsPrefix);

                            return (InsumoGastoEstimadoPJ) ExtensionMapper.getTypeObject(nsUri,
                                    type, reader);
                        }
                    }
                }
                ...
                if ((reader.isStartElement() &&
                        ...
                        new javax.xml.namespace.QName("", "mensagem").equals(
                                reader.getName())) {
                    object.setMensagem(MensagemGastoEstimadoPJ.Factory.parse(
                            reader));
