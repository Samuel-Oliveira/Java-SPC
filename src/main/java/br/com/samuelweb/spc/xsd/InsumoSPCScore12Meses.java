 ...
 */
public class InsumoSPCScore12Meses implements org.apache.axis2.databinding.ADBBean {
        /* This type was generated from the piece of schema that had
           name = Insumo-SPC-Score-12-Meses
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                        ...
                        namespacePrefix + ":Insumo-SPC-Score-12-Meses",
                        xmlWriter);
            } else {
                writeAttribute("xsi",
                        "http://www.w3.org/2001/XMLSchema-instance", "type",
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"Insumo-SPC-Score-12-Meses".equals(type)) {
                            ...
                            return (InsumoSPCScore12Meses) ExtensionMapper.getTypeObject(nsUri,
                                    type, reader);
                        }
                    }
                }
