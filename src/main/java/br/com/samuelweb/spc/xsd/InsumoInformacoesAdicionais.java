 ...
 */
public class InsumoInformacoesAdicionais implements org.apache.axis2.databinding.ADBBean {
        /* This type was generated from the piece of schema that had
           name = Insumo-Informacoes-Adicionais
           Namespace URI = http://webservice.consulta.spcjava.spcbrasil.org/
           Namespace Prefix = ns1
         */

    /**
     * field for FraseStatusEmpresa
     ...
     * @param param FraseStatusEmpresa
     */
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                        ...
                        namespacePrefix + ":Insumo-Informacoes-Adicionais",
                        xmlWriter);
            } else {
                writeAttribute("xsi",
                        "http://www.w3.org/2001/XMLSchema-instance", "type",
                        "Insumo-Informacoes-Adicionais", xmlWriter);
            }
        }
        ...
        if (localFraseStatusEmpresa != null) {
            writeAttribute("", "frase-status-empresa",
                    org.apache.axis2.databinding.utils.ConverterUtil.convertToString(
                            localFraseStatusEmpresa), xmlWriter);
        }
    ...
    public static class Factory {
        ...
        public static InsumoInformacoesAdicionais parse(
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"Insumo-Informacoes-Adicionais".equals(type)) {
                            ...
                            return (InsumoInformacoesAdicionais) ExtensionMapper.getTypeObject(nsUri,
                                    type, reader);
                        }
                    }
                }
                ...
                java.lang.String tempAttribFraseStatusEmpresa = reader.getAttributeValue(null,
                        "frase-status-empresa");

                if (tempAttribFraseStatusEmpresa != null) {
                    java.lang.String content = tempAttribFraseStatusEmpresa;

                    object.setFraseStatusEmpresa(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(
                            tempAttribFraseStatusEmpresa));
                } else {
                }
