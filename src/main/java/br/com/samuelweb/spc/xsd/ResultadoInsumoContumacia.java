 ...
 */
public class ResultadoInsumoContumacia extends ResultadoInsumo
        implements org.apache.axis2.databinding.ADBBean {
        /* This type was generated from the piece of schema that had
           name = Resultado-Insumo-Contumacia
           Namespace URI = http://webservice.consulta.spcjava.spcbrasil.org/
           Namespace Prefix = ns1
         */

    /**
     * field for DataFinalPeriodoConsultado
     * This was an Attribute!
     */
    protected java.util.Calendar localDataFinalPeriodoConsultado;

    /**
     * field for DataInicialPeriodoConsultado
     * This was an Attribute!
     */
     ...
     * @param param DataFinalPeriodoConsultado
     */
    ...
    /**
     * Auto generated setter method
     * @param param DataInicialPeriodoConsultado
     */
    ...
    public void serialize(final javax.xml.namespace.QName parentQName,
        ...
        if ((namespacePrefix != null) &&
            ...
            writeAttribute("xsi",
                    ...
                    namespacePrefix + ":Resultado-Insumo-Contumacia", xmlWriter);
        } else {
            writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
        ...
        if (localDataFinalPeriodoConsultado != null) {
            writeAttribute("", "data-final-periodo-consultado",
                    org.apache.axis2.databinding.utils.ConverterUtil.convertToString(
                            localDataFinalPeriodoConsultado), xmlWriter);
        }

        if (localDataInicialPeriodoConsultado != null) {
            writeAttribute("", "data-inicial-periodo-consultado",
                    org.apache.axis2.databinding.utils.ConverterUtil.convertToString(
                            localDataInicialPeriodoConsultado), xmlWriter);
        }
        ...
        if (localResumoTracker) {
            ...
            localResumo.serialize(new javax.xml.namespace.QName("", "resumo"),
                    xmlWriter);
        }
        ...
        if (localResultadoInsumoChoice_type0Tracker) {
            if (localResultadoInsumoChoice_type0 != null) {
                for (int i = 0;
                     i < localResultadoInsumoChoice_type0.length; i++) {
    ...
    public static class Factory {
        ...
        public static ResultadoInsumoContumacia parse(
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"Resultado-Insumo-Contumacia".equals(type)) {
                            ...
                            return (ResultadoInsumoContumacia) ExtensionMapper.getTypeObject(nsUri,
                                    type, reader);
                        }
                    }
                }
                ...
                java.lang.String tempAttribDataFinalPeriodoConsultado = reader.getAttributeValue(null,
                ...
                if (tempAttribDataFinalPeriodoConsultado != null) {
                    ...
                    object.setDataFinalPeriodoConsultado(org.apache.axis2.databinding.utils.ConverterUtil.convertToDateTime(
                            tempAttribDataFinalPeriodoConsultado));
                } else {
                }
                ...
                java.lang.String tempAttribDataInicialPeriodoConsultado = reader.getAttributeValue(null,
                ...
                if (tempAttribDataInicialPeriodoConsultado != null) {
                    ...
                    object.setDataInicialPeriodoConsultado(org.apache.axis2.databinding.utils.ConverterUtil.convertToDateTime(
                            tempAttribDataInicialPeriodoConsultado));
                } else {
                }
                ...
                if ((reader.isStartElement() &&
                        new javax.xml.namespace.QName("", "resumo").equals(
                                reader.getName())) ||
                        new javax.xml.namespace.QName("", "resumo").equals(
                                reader.getName())) {
                ...
                try {
                    if (reader.isStartElement()) {
                        ...
                        list2.add(ResultadoInsumoChoice_type0.Factory.parse(
                                reader));
                        ...
                        object.setResultadoInsumoChoice_type0((ResultadoInsumoChoice_type0[]) org.apache.axis2.databinding.utils.ConverterUtil.convertToArray(
                                ResultadoInsumoChoice_type0.class, list2));
                    } // End of if for expected property start element
