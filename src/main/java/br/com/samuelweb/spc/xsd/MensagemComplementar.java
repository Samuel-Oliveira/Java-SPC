 ...
 * Data: 01/09/2017 - 10:19
 */
public class MensagemComplementar implements org.apache.axis2.databinding.ADBBean {
    ...
    public void addMensagem(java.lang.String param) {
        ...
        java.util.List list = org.apache.axis2.databinding.utils.ConverterUtil.toList(localMensagem);
        list.add(param);
        this.localMensagem = (java.lang.String[]) list.toArray(new java.lang.String[list.size()]);
    }
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                        ...
                        namespacePrefix + ":Mensagem-Complementar", xmlWriter);
            } else {
                writeAttribute("xsi",
                        "http://www.w3.org/2001/XMLSchema-instance", "type",
            ...
            if (localMensagem != null) {
                ...
                for (int i = 0; i < localMensagem.length; i++) {
                    if (localMensagem[i] != null) {
                        writeStartElement(null, namespace, "mensagem",
                                xmlWriter);
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"Mensagem-Complementar".equals(type)) {
                            ...
                            return (MensagemComplementar) ExtensionMapper.getTypeObject(nsUri,
                                    type, reader);
                        }
                    }
                }
                ...
                if ((reader.isStartElement() &&
                    ...
                    while (!loopDone1) {
                        ...
                        if (reader.isEndElement()) {
                            ...
                            if (new javax.xml.namespace.QName("", "mensagem").equals(
                                    reader.getName())) {
                                list1.add(reader.getElementText());
                            } else {
                                loopDone1 = true;
                    ...
                    object.setMensagem((java.lang.String[]) list1.toArray(
