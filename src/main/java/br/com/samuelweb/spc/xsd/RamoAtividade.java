 ...
 */
public class RamoAtividade implements org.apache.axis2.databinding.ADBBean {
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                        ...
                        namespacePrefix + ":Ramo-Atividade", xmlWriter);
            } else {
                writeAttribute("xsi",
                        "http://www.w3.org/2001/XMLSchema-instance", "type",
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"Ramo-Atividade".equals(type)) {
                            ...
                            return (RamoAtividade) ExtensionMapper.getTypeObject(nsUri,
                                    type, reader);
                        }
                    }
                }
