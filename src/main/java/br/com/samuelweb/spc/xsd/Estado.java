 ...
 */
public class Estado implements org.apache.axis2.databinding.ADBBean {
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                        ...
                        namespacePrefix + ":Estado", xmlWriter);
            } else {
                writeAttribute("xsi",
                        "http://www.w3.org/2001/XMLSchema-instance", "type",
                        "Estado", xmlWriter);
    ...
    public static class Factory {
        ...
        public static Estado parse(javax.xml.stream.XMLStreamReader reader)
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"Estado".equals(type)) {
                            ...
                            return (Estado) ExtensionMapper.getTypeObject(nsUri,
                                    type, reader);
                        }
                    }
                }
                ...
                java.lang.String tempAttribSiglaUf = reader.getAttributeValue(null,
                        "sigla-uf");

                if (tempAttribSiglaUf != null) {
                    java.lang.String content = tempAttribSiglaUf;

                    object.setSiglaUf(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(
                            tempAttribSiglaUf));
                } else {
                }
