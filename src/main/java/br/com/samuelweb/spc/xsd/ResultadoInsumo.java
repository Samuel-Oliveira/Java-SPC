 ...
 */
public class ResultadoInsumo implements org.apache.axis2.databinding.ADBBean {
        /* This type was generated from the piece of schema that had
           name = Resultado-Insumo
    ...
    /**
     * field for ResultadoInsumoChoice_type0
     * This was an Array!
     */
    ...
    public boolean isResumoSpecified() {
        return localResumoTracker;
    }
    ...
    public void setResumo(ResumoInsumo param) {
        localResumoTracker = param != null;

        this.localResumo = param;
    }

    public boolean isResultadoInsumoChoice_type0Specified() {
        return localResultadoInsumoChoice_type0Tracker;
    }
    ...
    /**
     * Auto generated setter method
     * @param param ResultadoInsumoChoice_type0
     */
    public void setResultadoInsumoChoice_type0(
            ResultadoInsumoChoice_type0[] param) {
        validateResultadoInsumoChoice_type0(param);

        localResultadoInsumoChoice_type0Tracker = param != null;
    ...
    public void addResultadoInsumoChoice_type0(
        ...
        java.util.List list = org.apache.axis2.databinding.utils.ConverterUtil.toList(localResultadoInsumoChoice_type0);
        list.add(param);
        this.localResultadoInsumoChoice_type0 = (ResultadoInsumoChoice_type0[]) list.toArray(new ResultadoInsumoChoice_type0[list.size()]);
    }
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                        ...
                        namespacePrefix + ":Resultado-Insumo", xmlWriter);
            } else {
                writeAttribute("xsi",
                        "http://www.w3.org/2001/XMLSchema-instance", "type",
                        "Resultado-Insumo", xmlWriter);
            }
        }
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"Resultado-Insumo".equals(type)) {
                            ...
                            return (ResultadoInsumo) ExtensionMapper.getTypeObject(nsUri,
                                    type, reader);
                        }
                    }
                }
