 ...
 */
public class InsumoChequeSemFundoVarejo implements org.apache.axis2.databinding.ADBBean {
        /* This type was generated from the piece of schema that had
           name = Insumo-Cheque-Sem-Fundo-Varejo
    ...
    public boolean isCidadeOcorrenciaSpecified() {
        return localCidadeOcorrenciaTracker;
    }
    ...
    /**
     * Auto generated setter method
     * @param param CidadeOcorrencia
     */
    public void setCidadeOcorrencia(Cidade param) {
        localCidadeOcorrenciaTracker = param != null;
    ...
    /**
     * Auto generated setter method
     * @param param DataOcorrenciaMaisRecente
     */
    ...
    /**
     * Auto generated setter method
     * @param param OrigemOcorrenciaMaisRecente
     */
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                        ...
                        namespacePrefix + ":Insumo-Cheque-Sem-Fundo-Varejo",
                        xmlWriter);
            } else {
                writeAttribute("xsi",
                        "http://www.w3.org/2001/XMLSchema-instance", "type",
                        "Insumo-Cheque-Sem-Fundo-Varejo", xmlWriter);
            }
        }

        if (localDataOcorrenciaMaisRecente != null) {
            writeAttribute("", "data-ocorrencia-mais-recente",
                    org.apache.axis2.databinding.utils.ConverterUtil.convertToString(
                            localDataOcorrenciaMaisRecente), xmlWriter);
        }

        if (localNumeroLoja != java.lang.Integer.MIN_VALUE) {
            writeAttribute("", "numero-loja",
                    org.apache.axis2.databinding.utils.ConverterUtil.convertToString(
                            localNumeroLoja), xmlWriter);
        }

        if (localOrigemOcorrenciaMaisRecente != null) {
            writeAttribute("", "origem-ocorrencia-mais-recente",
                    org.apache.axis2.databinding.utils.ConverterUtil.convertToString(
                            localOrigemOcorrenciaMaisRecente), xmlWriter);
        }

        if (localQuantidadeCheques != java.lang.Integer.MIN_VALUE) {
            writeAttribute("", "quantidade-cheques",
                    org.apache.axis2.databinding.utils.ConverterUtil.convertToString(
                            localQuantidadeCheques), xmlWriter);
        }
    ...
    public static class Factory {
        ...
        public static InsumoChequeSemFundoVarejo parse(
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"Insumo-Cheque-Sem-Fundo-Varejo".equals(type)) {
                            ...
                            return (InsumoChequeSemFundoVarejo) ExtensionMapper.getTypeObject(nsUri,
                                    type, reader);
                        }
                    }
                }
                ...
                java.lang.String tempAttribDataOcorrenciaMaisRecente = reader.getAttributeValue(null,
                ...
                if (tempAttribDataOcorrenciaMaisRecente != null) {
                    ...
                    object.setDataOcorrenciaMaisRecente(org.apache.axis2.databinding.utils.ConverterUtil.convertToDateTime(
                            tempAttribDataOcorrenciaMaisRecente));
                } else {
                }
                ...
                java.lang.String tempAttribNumeroLoja = reader.getAttributeValue(null,
                        "numero-loja");

                if (tempAttribNumeroLoja != null) {
                    java.lang.String content = tempAttribNumeroLoja;

                    object.setNumeroLoja(org.apache.axis2.databinding.utils.ConverterUtil.convertToInt(
                            tempAttribNumeroLoja));
                } else {
                ...
                java.lang.String tempAttribOrigemOcorrenciaMaisRecente = reader.getAttributeValue(null,
                ...
                if (tempAttribOrigemOcorrenciaMaisRecente != null) {
                    ...
                    object.setOrigemOcorrenciaMaisRecente(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(
                            tempAttribOrigemOcorrenciaMaisRecente));
                } else {
                }
                ...
                java.lang.String tempAttribQuantidadeCheques = reader.getAttributeValue(null,
                        "quantidade-cheques");

                if (tempAttribQuantidadeCheques != null) {
                    java.lang.String content = tempAttribQuantidadeCheques;

                    object.setQuantidadeCheques(org.apache.axis2.databinding.utils.ConverterUtil.convertToInt(
                            tempAttribQuantidadeCheques));
                } else {
                ...
                if ((reader.isStartElement() &&
                        new javax.xml.namespace.QName("",
                                "cidade-ocorrencia").equals(reader.getName())) ||
                        new javax.xml.namespace.QName("",
                                "cidade-ocorrencia").equals(reader.getName())) {
