 ...
 */
public class InsumoPendenciaFinanceira implements org.apache.axis2.databinding.ADBBean {
        /* This type was generated from the piece of schema that had
           name = Insumo-Pendencia-Financeira
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                        ...
                        namespacePrefix + ":Insumo-Pendencia-Financeira",
                        xmlWriter);
            } else {
                writeAttribute("xsi",
                        "http://www.w3.org/2001/XMLSchema-instance", "type",
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"Insumo-Pendencia-Financeira".equals(type)) {
                            ...
                            return (InsumoPendenciaFinanceira) ExtensionMapper.getTypeObject(nsUri,
                                    type, reader);
                        }
                    }
                }
