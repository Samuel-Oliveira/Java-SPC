 ...
 */
public class InsumoEnderecoCEPConsultado implements org.apache.axis2.databinding.ADBBean {
        /* This type was generated from the piece of schema that had
           name = Insumo-Endereco-CEP-Consultado
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                        ...
                        namespacePrefix + ":Insumo-Endereco-CEP-Consultado",
                        xmlWriter);
            } else {
                writeAttribute("xsi",
                        "http://www.w3.org/2001/XMLSchema-instance", "type",
                        "Insumo-Endereco-CEP-Consultado", xmlWriter);
            }
        }
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"Insumo-Endereco-CEP-Consultado".equals(type)) {
                            ...
                            return (InsumoEnderecoCEPConsultado) ExtensionMapper.getTypeObject(nsUri,
                                    type, reader);
                        }
                    }
                }
