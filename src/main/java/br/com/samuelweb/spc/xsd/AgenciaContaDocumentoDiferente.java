 ...
 */
public class AgenciaContaDocumentoDiferente implements org.apache.axis2.databinding.ADBBean {
        /* This type was generated from the piece of schema that had
           name = Agencia-Conta-Documento-Diferente
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                        ...
                        namespacePrefix + ":Agencia-Conta-Documento-Diferente",
                        xmlWriter);
            } else {
                writeAttribute("xsi",
                        "http://www.w3.org/2001/XMLSchema-instance", "type",
                        "Agencia-Conta-Documento-Diferente", xmlWriter);
            }
        }
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"Agencia-Conta-Documento-Diferente".equals(
                                type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                    .getNamespaceURI(nsPrefix);

                            return (AgenciaContaDocumentoDiferente) ExtensionMapper.getTypeObject(nsUri,
                                    type, reader);
                        }
                    }
                }
