 ...
 */
public class Filtro implements org.apache.axis2.databinding.ADBBean {
    ...
    public void serialize(final javax.xml.namespace.QName parentQName,
        ...
        if (localFiltro == null) {
            ...
            writeStartElement(null, namespace, "filtro", xmlWriter);
            ...
            localFiltro.serialize(MY_QNAME, xmlWriter);
        }
    }
                ...
                while (!reader.isEndElement()) {
                    if (reader.isStartElement()) {
                        if ((reader.isStartElement() &&
                                ...
                                new javax.xml.namespace.QName("", "filtro").equals(
                                        reader.getName())) {
                            nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance",
                                    "nil");
                            ...
                            if ("true".equals(nillableValue) ||
                                ...
                                object.setFiltro(FiltroConsulta.Factory.parse(
                                        reader));
                            }
