 ...
 */
public class InsumoAntecessora implements org.apache.axis2.databinding.ADBBean {
        /* This type was generated from the piece of schema that had
           name = Insumo-Antecessora
           Namespace URI = http://webservice.consulta.spcjava.spcbrasil.org/
           Namespace Prefix = ns1
         */

    /**
     * field for DataMotivo
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                        ...
                        namespacePrefix + ":Insumo-Antecessora", xmlWriter);
            } else {
                writeAttribute("xsi",
                        "http://www.w3.org/2001/XMLSchema-instance", "type",
                        "Insumo-Antecessora", xmlWriter);
            }
        }
    ...
    public static class Factory {
        ...
        public static InsumoAntecessora parse(
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"Insumo-Antecessora".equals(type)) {
                            ...
                            return (InsumoAntecessora) ExtensionMapper.getTypeObject(nsUri,
                                    type, reader);
                        }
                    }
                }
                ...
                java.lang.String tempAttribDataMotivo = reader.getAttributeValue(null,
                        "data-motivo");

                if (tempAttribDataMotivo != null) {
                    java.lang.String content = tempAttribDataMotivo;

                    object.setDataMotivo(org.apache.axis2.databinding.utils.ConverterUtil.convertToDateTime(
                            tempAttribDataMotivo));
                } else {
                }
