 ...
 */
public class QuadroAdministrativoQuadroSocialMaisCompletoPJ
        implements org.apache.axis2.databinding.ADBBean {
        /* This type was generated from the piece of schema that had
           name = QuadroAdministrativoQuadroSocialMaisCompletoPJ
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                        ...
                        namespacePrefix +
                                ":QuadroAdministrativoQuadroSocialMaisCompletoPJ",
                        xmlWriter);
            } else {
                writeAttribute("xsi",
                        "http://www.w3.org/2001/XMLSchema-instance", "type",
    ...
    public static class Factory {
         ...
         */
        public static QuadroAdministrativoQuadroSocialMaisCompletoPJ parse(
                javax.xml.stream.XMLStreamReader reader)
                throws java.lang.Exception {
            QuadroAdministrativoQuadroSocialMaisCompletoPJ object = new QuadroAdministrativoQuadroSocialMaisCompletoPJ();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"QuadroAdministrativoQuadroSocialMaisCompletoPJ".equals(
                                type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                    .getNamespaceURI(nsPrefix);

                            return (QuadroAdministrativoQuadroSocialMaisCompletoPJ) ExtensionMapper.getTypeObject(nsUri,
                                    type, reader);
                        }
                    }
                }
