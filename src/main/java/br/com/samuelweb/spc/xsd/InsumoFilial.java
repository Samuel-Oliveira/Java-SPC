 ...
 * Data: 01/09/2017 - 10:46
 */
public class InsumoFilial implements org.apache.axis2.databinding.ADBBean {
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                        ...
                        namespacePrefix + ":Insumo-Filial", xmlWriter);
            } else {
                writeAttribute("xsi",
                        "http://www.w3.org/2001/XMLSchema-instance", "type",
                        "Insumo-Filial", xmlWriter);
            }
        }
        ...
        if (localCodigoEmbratel != null) {
            writeAttribute("", "codigo-embratel",
                    org.apache.axis2.databinding.utils.ConverterUtil.convertToString(
                            localCodigoEmbratel), xmlWriter);
        }

        if (localNomeFilial != null) {
            writeAttribute("", "nome-filial",
                    org.apache.axis2.databinding.utils.ConverterUtil.convertToString(
                            localNomeFilial), xmlWriter);
        }
    ...
    public static class Factory {
        ...
        public static InsumoFilial parse(
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"Insumo-Filial".equals(type)) {
                            ...
                            return (InsumoFilial) ExtensionMapper.getTypeObject(nsUri,
                                    type, reader);
                        }
                    }
                }
                ...
                java.lang.String tempAttribCodigoEmbratel = reader.getAttributeValue(null,
                        "codigo-embratel");

                if (tempAttribCodigoEmbratel != null) {
                    java.lang.String content = tempAttribCodigoEmbratel;

                    object.setCodigoEmbratel(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(
                            tempAttribCodigoEmbratel));
                } else {
                }
                ...
                java.lang.String tempAttribNomeFilial = reader.getAttributeValue(null,
                        "nome-filial");

                if (tempAttribNomeFilial != null) {
                    java.lang.String content = tempAttribNomeFilial;

                    object.setNomeFilial(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(
                            tempAttribNomeFilial));
                } else {
                }
