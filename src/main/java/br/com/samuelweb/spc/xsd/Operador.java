 ...
 */
public class Operador implements org.apache.axis2.databinding.ADBBean {
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                        ...
                        namespacePrefix + ":Operador", xmlWriter);
            } else {
                writeAttribute("xsi",
                        "http://www.w3.org/2001/XMLSchema-instance", "type",
                        "Operador", xmlWriter);
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"Operador".equals(type)) {
                            ...
                            return (Operador) ExtensionMapper.getTypeObject(nsUri,
                                    type, reader);
                        }
                    }
                }
