 ...
 */
public class Resultado implements org.apache.axis2.databinding.ADBBean {
    ...
    public void serialize(final javax.xml.namespace.QName parentQName,
        ...
        if (localResultado == null) {
            ...
            localResultado.serialize(MY_QNAME, xmlWriter);
        }
    }
                    ...
                    if (reader.isStartElement()) {
                        if ((reader.isStartElement() &&
                                new javax.xml.namespace.QName(
                                        "http://webservice.consulta.spcjava.spcbrasil.org/",
                                        "resultado").equals(reader.getName())) ||
                                new javax.xml.namespace.QName("",
                                        "resultado").equals(reader.getName())) {
                            nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance",
                                    "nil");
                            ...
                            if ("true".equals(nillableValue) ||
                                ...
                                object.setResultado(ResultadoConsulta.Factory.parse(
                                        reader));
                            }
