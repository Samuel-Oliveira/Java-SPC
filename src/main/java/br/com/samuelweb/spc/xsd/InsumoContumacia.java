 ...
 */
public class InsumoContumacia extends InsumoContraOrdem implements org.apache.axis2.databinding.ADBBean {
        /* This type was generated from the piece of schema that had
           name = Insumo-Contumacia
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"Insumo-Contumacia".equals(type)) {
                            ...
                            return (InsumoContumacia) ExtensionMapper.getTypeObject(nsUri,
                                    type, reader);
                        }
                    }
                }
