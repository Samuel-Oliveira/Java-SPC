 ...
 */
public class InsumoContumaciaSRS implements org.apache.axis2.databinding.ADBBean {
        /* This type was generated from the piece of schema that had
           name = Insumo-Contumacia-SRS
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                        ...
                        namespacePrefix + ":Insumo-Contumacia-SRS", xmlWriter);
            } else {
                writeAttribute("xsi",
                        "http://www.w3.org/2001/XMLSchema-instance", "type",
                        "Insumo-Contumacia-SRS", xmlWriter);
            }
        }
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"Insumo-Contumacia-SRS".equals(type)) {
                            ...
                            return (InsumoContumaciaSRS) ExtensionMapper.getTypeObject(nsUri,
                                    type, reader);
                        }
                    }
                }
