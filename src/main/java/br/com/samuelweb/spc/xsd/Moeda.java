 ...
 */
public class Moeda implements org.apache.axis2.databinding.ADBBean {
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                        ...
                        namespacePrefix + ":Moeda", xmlWriter);
            } else {
                writeAttribute("xsi",
                        "http://www.w3.org/2001/XMLSchema-instance", "type",
                        "Moeda", xmlWriter);
    ...
    public static class Factory {
        ...
        public static Moeda parse(javax.xml.stream.XMLStreamReader reader)
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"Moeda".equals(type)) {
                            ...
                            return (Moeda) ExtensionMapper.getTypeObject(nsUri,
                                    type, reader);
                        }
                    }
                }
                ...
                java.lang.String tempAttribSimbolo = reader.getAttributeValue(null,
                        "simbolo");

                if (tempAttribSimbolo != null) {
                    java.lang.String content = tempAttribSimbolo;

                    object.setSimbolo(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(
                            tempAttribSimbolo));
                } else {
                }
