 ...
 */
public class Cartorio implements org.apache.axis2.databinding.ADBBean {
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                        ...
                        namespacePrefix + ":Cartorio", xmlWriter);
            } else {
                writeAttribute("xsi",
                        "http://www.w3.org/2001/XMLSchema-instance", "type",
                        "Cartorio", xmlWriter);
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"Cartorio".equals(type)) {
                            ...
                            return (Cartorio) ExtensionMapper.getTypeObject(nsUri,
                                    type, reader);
                        }
                    }
                }
